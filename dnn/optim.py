...
class SGD(Optimizer):
    def __init__(self, parameters, learning_rate=0.01, momentum = 0.5, weight_decay=0.001):
    ...
    def step(self):
        for module in self.parameters:
            if isinstance(module, Updatable):
                module.old_d_W = self.momentum * module.old_d_W - self.learning_rate * module.d_W - self.weight_decay * module.weight
...
class Adam(SGD):
    def __init__(self, parameters, learning_rate=0.01, momentum = 0.5, weight_decay=0.001):
        #TODO
        super().__init__(parameters=parameters, learning_rate=learning_rate, momentum=momentum, weight_decay=weight_decay)
        for module in self.parameters:
            if isinstance(module, Updatable):
                module.old_d_W = 0
                module.old_d_b = 0
